...
The TPL is designed to be a literal translation, so that the OL translator can see the forms of the original biblical languages. The TPS is designed to be a dynamic translation, so that the OL translator can understand the meaning of these forms in the Bible. When translating these resources, please translate the TPL in a literal way and translate the TPS in a dynamic way. For more information about these resources, see the [Gateway Language Manual](https://gl-manual.readthedocs.io/en/latest/).
